...
public class SuperAdmin {
    ...
    @OneToOne
    @MapsId // Ensures that Super Admin ID is the same as user ID (hence an Admin with ID 1 is the person with user ID 1)
...
//    private String lastName;
    ...
    /* Entity relationship */
    @OneToOne
    @JoinColumn(name = "ppa_id", nullable = false, unique = true)
    private Ppa ppa;
//    @ManyToOne
